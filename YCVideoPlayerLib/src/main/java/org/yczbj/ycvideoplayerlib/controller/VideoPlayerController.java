    ...
    public void onPlayStateChanged(int playState) {
        switch (playState) {
            case ConstantKeys.CurrentState.STATE_IDLE:
                Log.d("chamo1","STATE_IDLE");
                break;
            //播放准备中
            case ConstantKeys.CurrentState.STATE_PREPARING:
                mImage.setVisibility(View.VISIBLE);
                Log.d("chamo1","STATE_PREPARING");
                startPreparing();
                break;
            //播放准备就绪
            case ConstantKeys.CurrentState.STATE_PREPARED:
                Log.d("chamo1","STATE_PREPARED");
...
//                cancelUpdateNetSpeedTimer();
            ...
            case ConstantKeys.CurrentState.STATE_BUFFERING_PAUSED:
                Log.d("chamo1","STATE_BUFFERING_PAUSED");
                mLoading.setVisibility(View.VISIBLE);
                mRestartPause.setImageResource(R.drawable.ic_player_start);
                mLoadText.setText("正在准备...");
                cancelDismissTopBottomTimer();
            ...
            case ConstantKeys.CurrentState.STATE_ERROR:
                Log.d("chamo1","STATE_ERROR");
                stateError();
                break;
            //播放完成
            case ConstantKeys.CurrentState.STATE_COMPLETED:
                Log.d("chamo1","STATE_COMPLETED");
                stateCompleted();
                break;
            default:
                break;
...
//        startUpdateNetSpeedTimer();
    ...
    private void stateError() {
        ...
        reset_timer.scheduleAtFixedRate(updateReset, 1000, 1000);
    }
